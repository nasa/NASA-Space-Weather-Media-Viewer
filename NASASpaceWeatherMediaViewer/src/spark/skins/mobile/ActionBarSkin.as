...
public class ActionBarSkin extends MobileSkin
{
    ...
    //    var chromeColor:uint = getStyle("chromeColor");
		...
		trace("chromeColor:",chromeColor,getStyle("chromeColor"))
    }
...
class TitleDisplayComponent extends UIComponent implements IDisplayText
{
    ...
    override protected function createChildren():void
    {
        ...
        titleDisplayShadow.multiline = true;
        titleDisplayShadow.wordWrap = true;
        
        addChild(titleDisplayShadow);
        addChild(titleDisplay);
		
		trace("text created in action bar class")
    }
